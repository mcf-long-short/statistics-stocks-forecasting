...
plot(pred_vals_1_winner, type="l",col="black", main="One-period-ahead forecast - Competitors + S&P500", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
...
plot(pred.vals.1.runner_up, type="l",col="black", main="One-period-ahead forecast - IBM & Google", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
...
plot(pred.vals.1.third, type="l",col="black", main="One-period-ahead forecast - Google & 3M", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
...
plot(pred_vals_5_winner, type="l",col="black", main="Multi-period-ahead forecast - Competitors + S&P500", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
...
plot(pred.vals.5.runner_up, type="l",col="black", main="Multi-period-ahead forecast - IBM & Google", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
...
plot(pred.vals.5.third, type="l",col="black", main="Multi-period-ahead forecast - Google & 3M", xlab="Days ahead", ylab="Returns")
lines(as.numeric(MSFT_daily_ret_test), type="l", pch=22, lty=2, col="red")
```
