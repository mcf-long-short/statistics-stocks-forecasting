...
``` {r echo=FALSE, warning=FALSE}
predictions <- forecast@forecast$sigmaFor
...
predictions <- egarch_forecast@forecast$sigmaFor
target_values <- egarch_forecast@forecast$seriesFor

selected_model_rmse <- rmse(predictions, target_values)

print(sprintf("RMSE of EGARCH model %f", selected_model_rmse))
```
IGARCH: 
``` {r echo=FALSE, warning=FALSE}
...
predictions <- igarch_forecast@forecast$sigmaFor
target_values <- igarch_forecast@forecast$seriesFor

selected_model_rmse <- rmse(predictions, target_values)

print(sprintf("RMSE of IGARCH model %f", selected_model_rmse))
```
